...
void Controller::receive(std::shared_ptr<Event> e)
{
    try 
    {
       makeAMove(e);
...
void Controller::makeAMove(std::shared_ptr<Event> e)
{
...
void Controller::catchingBadCastError(const std::bad_cast& error, std::shared_ptr<Event> e)
{
